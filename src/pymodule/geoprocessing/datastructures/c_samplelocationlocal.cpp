...
void init_c_SampleLocationLocal(py::module& m)
{
    ...
    py::class_<SampleLocationLocal>(
        ...
        .def("__eq__",
             ...
             py::arg("other"))
        .def_readwrite("x",
                       &SampleLocationLocal::x,
                       DOC_SampleLocationLocal(x)
        .def_readwrite("y",
                       &SampleLocationLocal::y,
                       DOC_SampleLocationLocal(y))
        .def_readwrite("z",
                       &SampleLocationLocal::z,
                       DOC_SampleLocationLocal(z))
        .def_readwrite("true_range",
                       &SampleLocationLocal::true_range,
                       DOC_SampleLocationLocal(true_range))
