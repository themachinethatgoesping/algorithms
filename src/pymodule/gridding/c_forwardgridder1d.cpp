...
void init_ForwardGridder1D_float(pybind11::module& m, const std::string& suffix)
{
    ...
    py::classh<T_ForwardGridder1D>(
        ...
        .def("get_x_index",
             py::vectorize(&T_ForwardGridder1D::get_x_index),
