...
// -- c++ library headers
#include "../themachinethatgoesping/algorithms/navtools.hpp"
...
using namespace themachinethatgoesping::algorithms::navtools;
...
void init_m_navtools(py::module& m)
{
    ...
    auto pyenum_latlon = py::enum_<t_latlon_format>(
                             m_navtools,
                             "t_latlon_format",
                             DOC(themachinethatgoesping, algorithms, navtools, t_latlon_format))
    ...
    m_navtools.def("latitude_to_string",
                   &latitude_to_string,
                   DOC(themachinethatgoesping, algorithms, navtools, latitude_to_string),
                   py::arg("latitude"),
    ...
    m_navtools.def("longitude_to_string",
                   &longitude_to_string,
                   DOC(themachinethatgoesping, algorithms, navtools, longitude_to_string),
                   py::arg("longitude"),
                   py::arg("format")    = t_latlon_format::minutes,
                   py::arg("precision") = 6);
    ...
    m_navtools.def(
        ...
        py::overload_cast<const std::vector<double>&, const std::vector<double>&, int, bool>(
            &utm_to_latlon),
        // DOC(themachinethatgoesping, algorithms, navtools, utm_to_latlon),
        py::arg("northing"),
        py::arg("easting"),
        py::arg("zone"),
